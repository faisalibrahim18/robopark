  ...
  return (
    <div className="login-form login-signin" style={{ display: "block" }}>
      ...
      <div className="text-center mb-10 mb-lg-20">
        ...
        <p className="text-light register-and-get-free-trial">
      ...
      >
        ...
        <div className="form-group d-flex align-items-end justify-content-between">
          <label className="mr-4 text-light" for="exampleFormControlSelect1">{t('language')}</label>
          <select 
        ...
        <div className="form-group">
          <label className="checkbox">
            ...
            />
            {t('iAgreeThe')}{" "}
            <Link to="/terms" target="_blank" rel="noopener noreferrer" className="text-light text-decoration-none">
            {t('terms&Conditions')}
            </Link>
            .
            <span />
